...
export default function Home() {
  const catalog = [
    ...
    { description: "", label: "Edital", href: "/" },
    { description: "", label: "Termo de Referência", href: "/" },
    { description: "", label: "Documento", href: "/" },
    { description: "", label: "Boleto", href: "/" },
    { description: "", label: "Requerimento", href: "/" },
  ];
                ...
                <li key={index}>
                  <div className=" bg-blue-300 md:w-52 md:h-52 hover:scale-110 p-2 rounded-lg flex flex-col justify-between">
                    <svg
                      ...
                      height="60"
                      fill="currentColor"
                      className="bi bi-file-earmark-pdf mx-auto"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <a
                        href={item.href}
                        className="bg-gray-600 w-11/12 mx-auto p-1 rounded-lg text-white"
                      >
